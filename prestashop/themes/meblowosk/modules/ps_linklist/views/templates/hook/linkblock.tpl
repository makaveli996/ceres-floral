 ...
 *}
{assign var="isNavHook" value=($hookName == 'displayNav1' || $hookName == 'displayNav2')}
{if $isNavHook}
  {* Header nav (displayNav1, displayNav2): no title, nav-* classes *}
  <div class="nav-linklist">
    {foreach $linkBlocks as $linkBlock}
      <div class="nav-linkblock">
        <ul id="nav_sub_menu_{$linkBlock.id}">
...
{else}
  {* Footer and other hooks: title + footer-* classes *}
  <div class="footer-linklist">
    <div class="footer-linklist__row">
    {foreach $linkBlocks as $linkBlock}
