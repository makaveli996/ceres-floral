...
<section id="content" class="page-content page-not-found">
  {block name='page_content'}
    ...
    {block name='search'}
      {* Brak drugiego pola wyszukiwania w pustym #js-product-list (szukajka jest w nagłówku). Ustaw notFoundHideSearch przy include. *}
      {if !isset($notFoundHideSearch) || !$notFoundHideSearch}
